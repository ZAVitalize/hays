webpackJsonp([4], {
        ...
        s = function(e) {
            return function(e) {
                ...
                e.exports = function(e, t, i, s, a, n) {
                    ...
                    var d, h = "function" == typeof o ? o.options : o;
                    if (t && (h.render = t.render, h.staticRenderFns = t.staticRenderFns, h._compiled = !0), i && (h.functional = !0), a && (h._scopeId = a), n ? (d = function(e) {
                            (e = e || this.$vnode && this.$vnode.ssrContext || this.parent && this.parent.$vnode && this.parent.$vnode.ssrContext) || "undefined" == typeof __VUE_SSR_CONTEXT__ || (e = __VUE_SSR_CONTEXT__), s && s.call(this, e), e && e._registeredComponents && e._registeredComponents.add(n)
                        }, h._ssrRegister = d) : s && (d = s), d) {
                        var p = h.functional,
                            c = p ? h.render : h.beforeCreate;
                        p ? (h._injectStyles = d, h.render = function(e, t) {
                ...
                var a = s(i(0)),
                    ...
                    d = n.default,
                    h = function(e, t) {
                        t && (r.default.props.globalOptions.default = function() {
                            return t
                        }), e.component(r.default.name, r.default), e.component(n.default.name, n.default)
                    },
                    p = {
                        Swiper: o,
                        swiper: l,
                ...
                t.default = p, t.Swiper = o, t.swiper = l, t.swiperSlide = d, t.install = h
            }, function(e, t, i) {
                "use strict";
                Object.defineProperty(t, "__esModule", {
                    value: !0
                        ...
                        bindEvents: function() {
                            ...
                            n.forEach(function(i) {
                                e.swiper.on(i, function() {
                                    t.$emit.apply(t, [i].concat(Array.prototype.slice.call(arguments))), t.$emit.apply(t, [i.replace(/([A-Z])/g, "-$1").toLowerCase()].concat(Array.prototype.slice.call(arguments)))
                                })
                            })
                        }
                    }
            ...
            t.a = {
                ...
                computed: {
                    ...
                    messageInfo: function() {
                        return "null" == localStorage.getItem("noReadNum") ? 0 : 1
                    }
                },
                watch: {
                    "InitData.setting": function(e) {
                        this.UserInfo && e.info_w && "" != e.info_w && (this.showNoticeW = !0)
                    }
                },
                created: function() {
                    var e = this;
                    this.$Model.GetUserInfo(function(t) {
                        1 == t.code && 0 == t.info.tax && t.info.vip_level > 1 && e.$Dialog.Alert1(e.$t("tax[0]"), function() {
                            e.$router.push("/user/account")
                        })
                    }), e.taskType = e.InitData.taskclasslist[0].group_id;
                    var t = this;
                    localStorage.getItem("showD");
                    this.$Model.GetBackData(function(e) {
                        e.noticelist && e.noticelist.length > 0 && (localStorage.setItem("showD", "1"), t.showNotice = !0)
                    })
                },
                mounted: function() {
                    this.InitData.memberList && this.InitData.memberList.length && this.$nextTick(function() {
                        for (var t = e("#SwipeList1 .van-swipe-item").slice(0, 5), i = 0; i < t.length; i++) e("#SwipeList1").children().append(e(t[i])[0].outerHTML)
                    }), this.InitData.businessList && this.InitData.businessList.length && this.$nextTick(function() {
                        for (var t = e("#SwipeList2 .van-swipe-item").slice(0, 5), i = 0; i < t.length; i++) e("#SwipeList2").children().append(e(t[i])[0].outerHTML)
                    })
                },
                activated: function() {},
                destroyed: function() {},
                methods: {
                    loadData: function() {
                        var e = this;
                        this.$Model.ProductList({}, function(t) {
                            e.productList = t.info
                        })
                    },
                    goTask: function(e, t) {
                        3 == t ? this.$toast.fail(this.$t("home.msg")) : this.$router.push("/task/" + e)
                    },
                    goTask1: function() {
                        this.UserInfo ? this.$router.push("/taskList/" + this.taskType + "/" + this.UserInfo.vip_level) : this.$router.push("/taskList/" + this.taskType + "/1")
                    },
                    goPost: function(e) {
                        this.$router.push({
                            name: "postTask",
                    ...
                    goMiLiao: function() {
                        this.$parent.showMiliao = !0
                    },
                    openVideo: function(e) {
                        this.InitData.videovTutorial && 1 == this.InitData.videovTutorial.length ? this.$router.push("/article/video/" + this.InitData.videovTutorial[0].id) : this.InitData.videovTutorial && this.InitData.videovTutorial.length > 1 ? this.$router.push("/video_index/" + e) : this.$Dialog.Toast(this.$t("home.video"))
                    },
                    openProfile: function(e) {
                        this.$router.push("/company_profile/" + e)
                    },
                    onLoad: function() {
                        this.getListData("load")
                    },
                    changeTabs: function(e) {
                        this.taskType = this.InitData.taskclasslist.filter(function(e) {
                            return 1 == e.state
                        })[e].group_id;
                        var t = (new Date).getTime() + 3e5,
                            i = localStorage.getItem("expTime");
                        if (void 0 != i && null != i)
                            if (parseInt(i) < (new Date).getTime()) {
                                for (var s = [], a = 0; a < localStorage.length; a++) localStorage.key(a).indexOf("cache") >= 0 && s.push(localStorage.key(a));
                                for (var n = 0; n < s.length; n++) localStorage.removeItem(s[n]);
                                localStorage.setItem("expTime", t), this.getListData("")
                            } else this.getListData("cache");
                        else localStorage.setItem("expTime", t), this.getListData("")
                    },
                    getListData: function(e) {
                        var t = this;
                        if ("cache" == e) {
                            var i = localStorage.getItem("cache:" + this.taskType + "_" + this.UserInfo.vip_level);
                            if (i) return this.listData = JSON.parse(i), !1
                        }
                        this.isLoad = !0, this.isRefresh = !1, "load" == e ? this.pageNo += 1 : (this.pageNo = 1, this.isFinished = !1), this.$Model.GetTaskList({
                            group_id: this.taskType,
                            task_level: this.UserInfo.vip_level,
                            page_no: this.pageNo,
                            is_u: 0
                        }, function(i) {
                            t.$nextTick(function() {
                                t.isLoad = !1
                            }), 1 == i.code ? ("load" == e ? 1 == t.pageNo ? t.listData = i.info : t.listData = t.listData.concat(i.info) : t.listData = i.info, t.pageNo == i.data_total_page ? t.isFinished = !0 : t.isFinished = !1, localStorage.setItem("cache:" + t.taskType + "_" + t.UserInfo.vip_level, a()(t.listData))) : (t.listData = [], t.isFinished = !0)
                        })
                    },
                    onRefresh: function() {
                        this.getListData("init")
                    },
                    receiveTask: function(e, t, i) {
                        var s = this;
                        localStorage.Token ? this.$Model.ReceiveTask(e, function(e) {
                            1 == e.code && (s.$router.push("/taskShow/" + e.data), t.is_l = 1, s.pageNo = 0)
                        }) : this.$router.push("/login")
                    },
                    jumpVipTask: function(e) {
                        this.UserInfo && this.$router.push("/taskList/" + this.taskType + "/" + this.UserInfo.vip_level)
                    },
                    jumpTask: function() {
                        this.UserInfo && this.$router.push("/taskList/" + this.taskType + "/" + this.UserInfo.vip_level)
                    },
                    jumpService: function() {
                        this.InitData.serviceList.length > 1 && this.$router.push("/kefu_list"), 1 == this.InitData.serviceList.length && this.$Util.OpenUrl(this.InitData.serviceList[0].url)
                    }
                }
            }
        }).call(t, i("7t+N"))
        ...
        s = function() {
                ...
                if (s)
                    if ("string" == typeof s) {
                        ...
                        if (d.indexOf("<") >= 0 && d.indexOf(">") >= 0) {
                            ...
                            for (o = a || "#" !== s[0] || s.match(/[ .<>:~]/) ? (a || e).querySelectorAll(s.trim()) : [e.getElementById(s.trim().split("#")[1])], r = 0; r < o.length; r += 1) o[r] && n.push(o[r])
            ...
            var n = {
                    ...
                    function l(e) {
                        ...
                        if (t) {
                            ...
                            if (i.indexOf(e) < 0 && i.unshift(e), s(t).is(n)) r.apply(t, i);
                                ...
                                for (var a = s(t).parents(), o = 0; o < a.length; o += 1) s(a[o]).is(n) && r.apply(a[o], i)
                        }
                    }
                        ...
                        for (var d = o[l], h = 0; h < this.length; h += 1) {
                            ...
                            if (!a && p.dom7Listeners ? c = p.dom7Listeners[d] : a && p.dom7LiveListeners && (c = p.dom7LiveListeners[d]), c && c.length)
                                for (var u = c.length - 1; u >= 0; u -= 1) {
                                    var f = c[u];
                                    n && f.listener === n ? (p.removeEventListener(d, f.proxyListener, r), c.splice(u, 1)) : n && f.listener && f.listener.dom7proxy && f.listener.dom7proxy === n ? (p.removeEventListener(d, f.proxyListener, r), c.splice(u, 1)) : n || (p.removeEventListener(d, f.proxyListener, r), c.splice(u, 1))
                                }
                        }
                    return this
                },
                ...
                children: function(e) {
                    for (var t = [], n = 0; n < this.length; n += 1)
                        for (var r = this[n].childNodes, o = 0; o < r.length; o += 1) e ? 1 === r[o].nodeType && s(r[o]).is(e) && t.push(r[o]) : 1 === r[o].nodeType && t.push(r[o]);
                    return new i(a(t))
                },
                remove: function() {
            ...
            var u = {
                ...
                updateSlides: function() {
                    var e = this.params,
                        ...
                        c = r ? this.virtual.slides.length : p.length,
                        u = [],
                        f = [],
                        v = [],
                    ...
                    if (void 0 !== s) {
                        ...
                        for (var M, k = e.slidesPerColumn, P = S / k, $ = Math.floor(c / e.slidesPerColumn), z = 0; z < c; z += 1) {
                            C = 0;
                            var I = p.eq(z);
                            if (e.slidesPerColumn > 1) {
                                ...
                                if ("column" === e.slidesPerColumnFill || "row" === e.slidesPerColumnFill && e.slidesPerGroup > 1) {
                                    if ("column" === e.slidesPerColumnFill) O = z - (D = Math.floor(z / k)) * k, (D > $ || D === $ && O === k - 1) && (O += 1) >= k && (O = 0, D += 1);
                                    else {
                                        var N = Math.floor(z / e.slidesPerGroup);
                                        D = z - (O = Math.floor(z / e.slidesPerView) - N * e.slidesPerColumn) * e.slidesPerView - N * e.slidesPerView
                                    }
                                    L = D + O * S / k, I.css({
                            ...
                            if ("none" !== I.css("display")) {
                                if ("auto" === e.slidesPerView) {
                                    ...
                                    if (_ && (I[0].style.transform = "none"), H && (I[0].style.webkitTransform = "none"), e.roundLengths) C = this.isHorizontal() ? I.outerWidth(!0) : I.outerHeight(!0);
                                        ...
                                        C = F && "border-box" === F && !h.isIE ? G + X + Y : G + B + V + X + Y
                                    } else {
                                        ...
                                        C = K && "border-box" === K && !h.isIE ? R + W + U : R + j + q + W + U
                                    }
                                    _ && (I[0].style.transform = _), H && (I[0].style.webkitTransform = H), e.roundLengths && (C = Math.floor(C))
                                } else C = (s - (e.slidesPerView - 1) * y) / e.slidesPerView, e.roundLengths && (C = Math.floor(C)), p[z] && (this.isHorizontal() ? p[z].style.width = C + "px" : p[z].style.height = C + "px");
                                p[z] && (p[z].swiperSlideSize = C), v.push(C), e.centeredSlides ? (x = x + C / 2 + T / 2 + y, 0 === T && 0 !== z && (x = x - s / 2 - y), 0 === z && (x = x - s / 2 - y), Math.abs(x) < .001 && (x = 0), e.roundLengths && (x = Math.floor(x)), E % e.slidesPerGroup == 0 && u.push(x), f.push(x)) : (e.roundLengths && (x = Math.floor(x)), E % e.slidesPerGroup == 0 && u.push(x), f.push(x), x = x + C + y), this.virtualSize += C + y, T = C, E += 1
                            }
                        }
                        if (this.virtualSize = Math.max(this.virtualSize, s) + g, a && n && ("slide" === e.effect || "coverflow" === e.effect) && i.css({
                            ...
                            for (var Q = 0; Q < u.length; Q += 1) {
                                var Z = u[Q];
                                e.roundLengths && (Z = Math.floor(Z)), u[Q] < this.virtualSize + u[0] && M.push(Z)
                            }
                            u = M
                        }
                        if (!e.centeredSlides) {
                        ...
                        l.extend(this, {
                            ...
                            slidesGrid: f,
                            slidesSizesGrid: v
                        }), c !== o && this.emit("slidesLengthChange"), u.length !== b && (this.params.watchOverflow && this.checkOverflow(), this.emit("snapGridLengthChange")), f.length !== w && this.emit("slidesGridLengthChange"), (e.watchSlidesProgress || e.watchSlidesVisibility) && this.updateSlidesOffset()
                    }
                },
                ...
                updateProgress: function(e) {
                    ...
                    var t = this.params,
                        ...
                        r = a,
                        o = n;
                    0 === i ? (s = 0, a = !0, n = !0) : (a = (s = (e - this.minTranslate()) / i) <= 0, n = s >= 1), l.extend(this, {
                        progress: s,
                        isBeginning: a,
                        isEnd: n
            ...
            var f = {
                ...
                setTranslate: function(e, t) {
                    var i = this.rtlTranslate,
                        ...
                        r = 0,
                        o = 0;
                    this.isHorizontal() ? r = i ? -e : e : o = e, s.roundLengths && (r = Math.floor(r), o = Math.floor(o)), s.virtualTranslate || (d.transforms3d ? a.transform("translate3d(" + r + "px, " + o + "px, 0px)") : a.transform("translate(" + r + "px, " + o + "px)")), this.previousTranslate = this.translate, this.translate = this.isHorizontal() ? r : o;
            ...
            var m = {
                slideTo: function(e, t, i, s) {
                    ...
                    u >= o.length && (u = o.length - 1), (p || r.initialSlide || 0) === (h || 0) && i && a.emit("beforeSlideChangeStart");
                    var f, v = -o[u];
                ...
                slidePrev: function(e, t, i) {
                    ...
                    var d, h = l(o ? this.translate : -this.translate),
                        ...
                        c = (r.map(function(e) {
                            return l(e)
                        }), n[p.indexOf(h)], n[p.indexOf(h) - 1]);
                    return void 0 !== c && (d = r.indexOf(c)) < 0 && (d = this.activeIndex - 1), this.slideTo(d, e, t, i)
                },
                ...
                slideToClickedSlide: function() {
                    ...
                    if (i.loop) {
                        ...
                        e = parseInt(s(t.clickedSlide).attr("data-swiper-slide-index"), 10), i.centeredSlides ? r < t.loopedSlides - n / 2 || r > t.slides.length - t.loopedSlides + n / 2 ? (t.loopFix(), r = a.children("." + i.slideClass + '[data-swiper-slide-index="' + e + '"]:not(.' + i.slideDuplicateClass + ")").eq(0).index(), l.nextTick(function() {
                            t.slideTo(r)
                        })) : t.slideTo(r) : r > t.slides.length - n ? (t.loopFix(), r = a.children("." + i.slideClass + '[data-swiper-slide-index="' + e + '"]:not(.' + i.slideDuplicateClass + ")").eq(0).index(), l.nextTick(function() {
                            t.slideTo(r)
                        })) : t.slideTo(r)
                    } else t.slideTo(r)
                }
            ...
            var T = {
                    ...
                    events: {
                            ...
                            this.onTouchStart = function(i) {
                                ...
                                if (!this.animating || !n.preventInteractionOnTransition) {
                                    ...
                                    if (o.originalEvent && (o = o.originalEvent), a.isTouchEvent = "touchstart" === o.type, (a.isTouchEvent || !("which" in o) || 3 !== o.which) && !(!a.isTouchEvent && "button" in o && o.button > 0 || a.isTouched && a.isMoved))
                                        if (n.noSwiping && s(o.target).closest(n.noSwipingSelector ? n.noSwipingSelector : "." + n.noSwipingClass)[0]) this.allowClick = !0;
                                        else if (!n.swipeHandler || s(o).closest(n.swipeHandler)[0]) {
                                        ...
                                        if (!p || !(d <= c || d >= t.screen.width - c)) {
                                            if (l.extend(a, {
                                                    ...
                                                    isScrolling: void 0,
                                                    startMoving: void 0
                                                }), r.startX = d, r.startY = h, a.touchStartTime = l.now(), this.allowClick = !0, this.updateSize(), this.swipeDirection = void 0, n.threshold > 0 && (a.allowThresholdMove = !1), "touchstart" !== o.type) {
                                                var u = !0;
                                                ...
                                                (n.touchStartForcePreventDefault || f) && o.preventDefault()
                                            }
                                ...
                                if (o.originalEvent && (o = o.originalEvent), i.isTouched) {
                                    if (!i.isTouchEvent || "mousemove" !== o.type) {
                                        ...
                                        if (!this.allowTouchMove) return this.allowClick = !1, void(i.isTouched && (l.extend(n, {
                                            startX: d,
                                            startY: h,
                                            currentX: d,
                                            currentY: h
                                        ...
                                        if (i.allowTouchCallbacks && this.emit("touchMove", o), !(o.targetTouches && o.targetTouches.length > 1)) {
                                            ...
                                            var p, c = n.currentX - n.startX,
                                                u = n.currentY - n.startY;
                                            if (!(this.params.threshold && Math.sqrt(Math.pow(c, 2) + Math.pow(u, 2)) < this.params.threshold))
                                                if (void 0 === i.isScrolling && (this.isHorizontal() && n.currentY === n.startY || this.isVertical() && n.currentX === n.startX ? i.isScrolling = !1 : c * c + u * u >= 25 && (p = 180 * Math.atan2(Math.abs(u), Math.abs(c)) / Math.PI, i.isScrolling = this.isHorizontal() ? p > a.touchAngle : 90 - p > a.touchAngle)), i.isScrolling && this.emit("touchMoveOpposite", o), void 0 === i.startMoving && (n.currentX === n.startX && n.currentY === n.startY || (i.startMoving = !0)), i.isScrolling) i.isTouched = !1;
                                                else if (i.startMoving) {
                                                this.allowClick = !1, o.preventDefault(), a.touchMoveStopPropagation && !a.nested && o.stopPropagation(), i.isMoved || (a.loop && this.loopFix(), i.startTranslate = this.getTranslate(), this.setTransition(0), this.animating && this.$wrapperEl.trigger("webkitTransitionEnd transitionend"), i.allowMomentumBounce = !1, !a.grabCursor || !0 !== this.allowSlideNext && !0 !== this.allowSlidePrev || this.setGrabCursor(!0), this.emit("sliderFirstMove", o)), this.emit("sliderMove", o), i.isMoved = !0;
                                                var f = this.isHorizontal() ? c : u;
                                                n.diff = f, f *= a.touchRatio, r && (f = -f), this.swipeDirection = f > 0 ? "prev" : "next", i.currentTranslate = f + i.startTranslate;
                                                var v = !0,
                                                    m = a.resistanceRatio;
                                ...
                                if (i.isTouched = !1, i.isMoved = !1, i.startMoving = !1, p = s.followFinger ? n ? t.translate : -t.translate : -i.currentTranslate, s.freeMode) {
                                    ...
                                    if (s.freeModeMomentum) {
                                        ...
                                        s.freeModeMomentumBounce && E ? (t.updateProgress(x), t.setTransition(b), t.setTranslate(y), t.transitionStart(!0, t.swipeDirection), t.animating = !0, r.transitionEnd(function() {
                                    ...
                                    for (var k = 0, P = t.slidesSizesGrid[0], $ = 0; $ < o.length; $ += s.slidesPerGroup) void 0 !== o[$ + s.slidesPerGroup] ? p >= o[$] && p < o[$ + s.slidesPerGroup] && (k = $, P = o[$ + s.slidesPerGroup] - o[$]) : p >= o[$] && (k = $, P = o[o.length - 1] - o[o.length - 2]);
                                    var z = (p - o[k]) / P;
                                    if (u > s.longSwipesMs) {
                        ...
                        detachEvents: function() {
                            ...
                            if (d.touch || !d.pointerEvents && !d.prefixedPointerEvents) {
                                ...
                                }(t.simulateTouch && !y.ios && !y.android || t.simulateTouch && !d.touch && y.ios) && (n.removeEventListener("mousedown", this.onTouchStart, !1), e.removeEventListener("mousemove", this.onTouchMove, r), e.removeEventListener("mouseup", this.onTouchEnd, !1))
                            ...
                            (t.preventClicks || t.preventClicksPropagation) && n.removeEventListener("click", this.onClick, !0), this.off(y.ios || y.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", x)
                        }
                    },
                    breakpoints: {
                        setBreakpoint: function() {
                            ...
                            if (a && (!a || 0 !== Object.keys(a).length)) {
                                ...
                                if (n && this.currentBreakpoint !== n) {
                                    ...
                                    }), this.currentBreakpoint = n, h && t && (this.loopDestroy(), this.loopCreate(), this.updateSlides(), this.slideTo(e - i + this.loopedSlides, 0, !1)), this.emit("breakpoint", o)
                                }
                            }
                        },
                        getBreakpoint: function(e) {
                            if (e) {
                                ...
                                for (var a = 0; a < s.length; a += 1) {
                                    var n = s[a];
                                    this.params.breakpointsInverse ? n <= t.innerWidth && (i = n) : n >= t.innerWidth && !i && (i = n)
                                }
                                return i || "max"
                            }
                        }
                ...
                C = function(e) {
                    function t() {
                        ...
                        1 === r.length && r[0].constructor && r[0].constructor === Object ? n = r[0] : (a = (i = r)[0], n = i[1]), n || (n = {}), n = l.extend({}, n), a && !n.el && (n.el = a), e.call(this, n), Object.keys(E).forEach(function(e) {
                        ...
                        var p = l.extend({}, T);
                        h.useModulesParams(p), h.params = l.extend({}, p, S, n), h.originalParams = l.extend({}, h.params), h.passedParams = l.extend({}, n), h.$ = s;
                        var c = s(h.params.el);
                        if (a = c[0]) {
                            if (c.length > 1) {
                                var u = [];
                            ...
                            var f, v, m = c.children("." + h.params.wrapperClass);
                            return l.extend(h, {
                                $el: c,
                                el: a,
                                $wrapperEl: m,
                                ...
                                touchEvents: (f = ["touchstart", "touchmove", "touchend"], v = ["mousedown", "mousemove", "mouseup"], d.pointerEvents ? v = ["pointerdown", "pointermove", "pointerup"] : d.prefixedPointerEvents && (v = ["MSPointerDown", "MSPointerMove", "MSPointerUp"]), h.touchEventsTouch = {
                                    start: f[0],
                                    move: f[1],
                                    end: f[2]
                ...
                L = {
                    update: function(e) {
                        ...
                        g = t.rtlTranslate ? "right" : t.isHorizontal() ? "left" : "top", n ? (b = Math.floor(s / 2) + a + o, w = Math.floor(s / 2) + a + d) : (b = s + (a - 1) + o, w = a + d);
                        ...
                        if (l.extend(t.virtual, {
                            ...
                            }), p === x && c === T && !e) return t.slidesGrid !== f && E !== m && t.slides.css(g, E + "px"), void t.updateProgress();
                        ...
                        if (e) t.$wrapperEl.find("." + t.params.slideClass).remove();
                            ...
                            for (var k = p; k <= c; k += 1)(k < x || k > T) && t.$wrapperEl.find("." + t.params.slideClass + '[data-swiper-slide-index="' + k + '"]').remove();
                        for (var P = 0; P < u.length; P += 1) P >= x && P <= T && (void 0 === c || e ? M.push(P) : (P > c && M.push(P), P < p && C.push(P)));
            ...
            var A = {
                    ...
                    enable: function() {
                        ...
                        var e = this.$el;
                        return "container" !== this.params.mousewheel.eventsTarged && (e = s(this.params.mousewheel.eventsTarged)), e.on("mouseenter", this.mousewheel.handleMouseEnter), e.on("mouseleave", this.mousewheel.handleMouseLeave), e.on(A.event, this.mousewheel.handle), this.mousewheel.enabled = !0, !0
                    },
                    disable: function() {
                        if (!A.event) return !1;
                        if (!this.mousewheel.enabled) return !1;
                        var e = this.$el;
                        return "container" !== this.params.mousewheel.eventsTarged && (e = s(this.params.mousewheel.eventsTarged)), e.off(A.event, this.mousewheel.handle), this.mousewheel.enabled = !1, !0
                    }
                },
                _ = {
                    update: function() {
                        ...
                        if (t.el && this.pagination.el && this.pagination.$el && 0 !== this.pagination.$el.length) {
                            ...
                            if ("fraction" === t.type && (n.find("." + t.currentClass).text(t.formatFractionCurrent(i + 1)), n.find("." + t.totalClass).text(t.formatFractionTotal(r))), "progressbar" === t.type) {
                                ...
                                var b = (i + 1) / r,
                                    w = 1,
                                    y = 1;
                                "horizontal" === g ? w = b : y = b, n.find("." + t.progressbarFillClass).transform("translate3d(0,0,0) scaleX(" + w + ") scaleY(" + y + ")").transition(this.params.speed)
                            }
                ...
                G = {
                    setTranslate: function() {
                        if (this.params.scrollbar.el && this.scrollbar.el) {
                            var e = this.scrollbar,
                                ...
                                l = s,
                                h = (a - s) * i;
                            t ? (h = -h) > 0 ? (l = s - h, h = 0) : -h + s > a && (l = a + h) : h < 0 ? (l = s + h, h = 0) : h + s > a && (l = a - h), this.isHorizontal() ? (d.transforms3d ? n.transform("translate3d(" + h + "px, 0, 0)") : n.transform("translateX(" + h + "px)"), n[0].style.width = l + "px") : (d.transforms3d ? n.transform("translate3d(0px, " + h + "px, 0)") : n.transform("translateY(" + h + "px)"), n[0].style.height = l + "px"), o.hide && (clearTimeout(this.scrollbar.timeout), r[0].style.opacity = 1, this.scrollbar.timeout = setTimeout(function() {
                    ...
                    updateSize: function() {
                        if (this.params.scrollbar.el && this.scrollbar.el) {
                            ...
                            var s, a = this.isHorizontal() ? i[0].offsetWidth : i[0].offsetHeight,
                                ...
                                r = n * (a / this.size);
                            s = "auto" === this.params.scrollbar.dragSize ? a * n : parseInt(this.params.scrollbar.dragSize, 10), this.isHorizontal() ? t[0].style.width = s + "px" : t[0].style.height = s + "px", i[0].style.display = n >= 1 ? "none" : "", this.params.scrollbar.hide && (i[0].style.opacity = 0), l.extend(e, {
                                trackSize: a,
                                divider: n,
                                moveDivider: r,
                                dragSize: s
                    ...
                    enableDraggable: function() {
                        if (this.params.scrollbar.el) {
                            ...
                            d.touch ? (n.addEventListener(i.start, this.scrollbar.onDragStart, r), n.addEventListener(i.move, this.scrollbar.onDragMove, r), n.addEventListener(i.end, this.scrollbar.onDragEnd, o)) : (n.addEventListener(s.start, this.scrollbar.onDragStart, r), e.addEventListener(s.move, this.scrollbar.onDragMove, r), e.addEventListener(s.end, this.scrollbar.onDragEnd, o))
                        }
                    },
                    disableDraggable: function() {
                        if (this.params.scrollbar.el) {
                            ...
                            d.touch ? (n.removeEventListener(i.start, this.scrollbar.onDragStart, r), n.removeEventListener(i.move, this.scrollbar.onDragMove, r), n.removeEventListener(i.end, this.scrollbar.onDragEnd, o)) : (n.removeEventListener(s.start, this.scrollbar.onDragStart, r), e.removeEventListener(s.move, this.scrollbar.onDragMove, r), e.removeEventListener(s.end, this.scrollbar.onDragEnd, o))
                        }
                    },
                    init: function() {
                        if (this.params.scrollbar.el) {
                            ...
                            0 === n.length && (n = s('<div class="' + this.params.scrollbar.dragClass + '"></div>'), a.append(n)), l.extend(e, {
                                $el: a,
                                el: a[0],
                                $dragEl: n,
                                dragEl: n[0]
                ...
                B = {
                    setTransform: function(e, t) {
                        ...
                        if (o || l ? (o = o || "0", l = l || "0") : this.isHorizontal() ? (o = r, l = "0") : (l = r, o = "0"), o = o.indexOf("%") >= 0 ? parseInt(o, 10) * t * n + "%" : o * t * n + "px", l = l.indexOf("%") >= 0 ? parseInt(l, 10) * t + "%" : l * t + "px", void 0 !== h && null !== h) {
                ...
                V = {
                    ...
                    in: function(e) {
                        var t, i, a, n, r, o, l, d, h, p, c, u, f, v, m, g, b = this.zoom,
                            w = this.params.zoom,
                            y = b.gesture,
                            x = b.image;
                    ...
                    load: function() {
                        ...
                        if (o.loadPrevNext)
                            if (l > 1 || o.loadPrevNextAmount && o.loadPrevNextAmount > 1) {
                                for (var c = o.loadPrevNextAmount, u = l, f = Math.min(n + u + Math.max(c, u), a.length), v = Math.max(n - Math.max(u, c), 0), m = n + l; m < f; m += 1) d(m) && e.lazy.loadInSlide(m);
                ...
                Y = {
                    ...
                    setTransition: function(e, t) {
                        ...
                        if (Array.isArray(a))
                            for (i = 0; i < a.length; i += 1) a[i] !== t && a[i] instanceof C && n(a[i]);
                ...
                R = {
                    init: function() {
                        if (this.params.history) {
                            ...
                            var e = this.history;
                            e.initialized = !0, e.paths = R.getPathValues(), (e.paths.key || e.paths.value) && (e.scrollToSlide(0, e.paths.value, this.params.runCallbacksOnInit), this.params.history.replaceState || t.addEventListener("popstate", this.history.setHistoryPopState))
                        }
                    },
                    destroy: function() {
                    ...
                    setHistory: function(e, i) {
                        if (this.history.initialized && this.params.history.enabled) {
                            var s = this.slides.eq(i),
                                a = R.slugify(s.attr("data-history"));
                    ...
                    scrollToSlide: function(e, t, i) {
                        if (t)
                            for (var s = 0, a = this.slides.length; s < a; s += 1) {
                                ...
                                if (R.slugify(n.attr("data-history")) === t && !n.hasClass(this.params.slideDuplicateClass)) {
                                    var r = n.index();
                                    this.slideTo(r, e, i)
                                }
                ...
                U = {
                    setTranslate: function() {
                        ...
                        for (var f = 0; f < a.length; f += 1) {
                            ...
                            if (w <= 1 && w > -1 && (u = 90 * m + 90 * w, o && (u = 90 * -m - 90 * w)), v.transform(E), d.slideShadows) {
                                ...
                                0 === S.length && (S = s('<div class="swiper-slide-shadow-' + (p ? "left" : "top") + '"></div>'), v.append(S)), 0 === C.length && (C = s('<div class="swiper-slide-shadow-' + (p ? "right" : "bottom") + '"></div>'), v.append(C)), S.length && (S[0].style.opacity = Math.max(-w, 0)), C.length && (C[0].style.opacity = Math.max(w, 0))
                            }
                        }
                        if (i.css({
                            ...
                            if (p) e.transform("translate3d(0px, " + (n / 2 + d.shadowOffset) + "px, " + -n / 2 + "px) rotateX(90deg) rotateZ(0deg) scale(" + d.shadowScale + ")");
                                ...
                                var M = Math.abs(u) - 90 * Math.floor(Math.abs(u) / 90),
                                    ...
                                    $ = d.shadowScale / k,
                                    z = d.shadowOffset;
                                e.transform("scale3d(" + P + ", 1, " + $ + ") translate3d(0px, " + (r / 2 + z) + "px, " + -r / 2 / $ + "px) rotateX(-90deg)")
                            }
                    ...
                    setTranslate: function() {
                        for (var e = this.slides, t = this.rtlTranslate, i = 0; i < e.length; i += 1) {
                            ...
                            if (this.isHorizontal() ? t && (r = -r) : (d = l, l = 0, o = -r, r = 0), a[0].style.zIndex = -Math.abs(Math.round(n)) + e.length, this.params.flipEffect.slideShadows) {
                                ...
                                0 === h.length && (h = s('<div class="swiper-slide-shadow-' + (this.isHorizontal() ? "left" : "top") + '"></div>'), a.append(h)), 0 === p.length && (p = s('<div class="swiper-slide-shadow-' + (this.isHorizontal() ? "right" : "bottom") + '"></div>'), a.append(p)), h.length && (h[0].style.opacity = Math.max(-n, 0)), p.length && (p[0].style.opacity = Math.max(n, 0))
                            }
                ...
                Q = {
                    setTranslate: function() {
                        for (var e = this.width, t = this.height, i = this.slides, a = this.$wrapperEl, n = this.slidesSizesGrid, r = this.params.coverflowEffect, o = this.isHorizontal(), l = this.translate, h = o ? e / 2 - l : t / 2 - l, p = o ? r.rotate : -r.rotate, c = r.depth, u = 0, f = i.length; u < f; u += 1) {
                            var v = i.eq(u),
                                m = n[u],
                            ...
                            if (v.transform(E), v[0].style.zIndex = 1 - Math.abs(Math.round(g)), r.slideShadows) {
                                ...
                                0 === S.length && (S = s('<div class="swiper-slide-shadow-' + (o ? "left" : "top") + '"></div>'), v.append(S)), 0 === C.length && (C = s('<div class="swiper-slide-shadow-' + (o ? "right" : "bottom") + '"></div>'), v.append(C)), S.length && (S[0].style.opacity = g > 0 ? g : 0), C.length && (C[0].style.opacity = -g > 0 ? -g : 0)
                            }
                    ...
                    onThumbClick: function() {
                        ...
                        if (e) {
                            var t = e.clickedIndex,
                                i = e.clickedSlide;
                            if (!(i && s(i).hasClass(this.params.thumbs.slideThumbActiveClass) || void 0 === t || null === t)) {
                                var a;
                    ...
                    create: function() {
                        l.extend(this, {
                            history: {
                                ...
                                setHistory: R.setHistory.bind(this),
                                setHistoryPopState: R.setHistoryPopState.bind(this),
                                scrollToSlide: R.scrollToSlide.bind(this),
    ...
    j7e0: function(e, t, i) {
            ...
            a = {
                render: function() {
                    var e = this,
                        ...
                        i = e._self._c || t;
                    return i("div", {
                        staticClass: "Site IndexBox IndexHome"
                    }, [i("div", {
                        staticClass: "ScrollBox",
                        staticStyle: {
                            background: "url('./static/images/BACKGROUND.41af007b.png') no-repeat",
                        ...
                        attrs: {
                            border: !1,
                            "left-text": e.$langList ? e.$t("language") : ""
                        },
                        on: {
                            "click-left": function(t) {
                                e.$langList && e.$router.push("/language")
                            },
                            "click-right": e.jumpService
                        },
                        scopedSlots: e._u([{
                            key: "right",
                            fn: function() {
                                return [e.InitData.serviceList.length > 0 ? i("img", {
                                    staticStyle: {
                                        height: "100%"
                                    },
                                    attrs: {
                            ...
                            fn: function() {
                                return [i("img", {
                                    ...
                                    attrs: {
                                        src: "./static/images/logo-en-US.png?t=2"
                                    }
                                })]
                            },
                            proxy: !0
                    ...
                    }, e._l(e.InitData.bannerList, function(t, s) {
                        return i("swiper-slide", {
                            ...
                            attrs: {
                                src: e.InitData.setting.up_url + t
                            }
                        })])
                    }), 1), e._v(" "), i("van-cell", {
                        ...
                        scopedSlots: e._u([{
                            ...
                            fn: function() {
                                return [i("van-icon", {
                                    ...
                                    attrs: {
                                        src: "./static/icon/home_notice.png"
                                    }
                                })])]
                            },
                            proxy: !0
                        ...
                        style: "id" == e.lang || "ma" == e.lang || "vi" == e.lang || "en" == e.lang ? "height:3rem !important;line-height:1rem;" : "height:2rem !important;line-height:1rem;",
                        attrs: {
                            "show-indicators": !1,
                            vertical: "",
                            autoplay: 3e3
                        }
                    }, [e.InitData.notifications ? e._l(e.InitData.notifications, function(t, s) {
                        return i("van-swipe-item", {
                            key: s
                        }, [i("span", {
                            staticClass: "Notification"
                        }, [e._v(e._s(t))])])
                    }) : e._e(), e._v(" "), e.InitData.notifications ? e._e() : e._l(e.InitData.userviplist, function(t, s) {
                        return i("van-swipe-item", {
                            key: s,
                            domProps: {
                                innerHTML: e._s(e.$t("home.broadcast", {
                                    member: t.username,
                                    vipname: t.child_vip_name,
                                    currency: e.InitData.currency,
                                    grade: t.name
                                }))
                            }
                        })
                        ...
                        attrs: {
                            ...
                            text: e.$t("wallet.default[2]"),
                            to: "/withdraw"
                        }
                    }), e._v(" "), i("van-grid-item", {
                        attrs: {
                            icon: "./static/images/55.png",
                            text: e.$t("wallet.default[1]"),
                            to: "/user/recharge"
                        }
                    })], 1), e._v(" "), i("van-grid", {
                        staticClass: "Menu m0",
                        ...
                        attrs: {
                            icon: "./static/images/44.png",
                            text: e.$t("user.menu[14]")
                        },
                        on: {
                            click: function(t) {
                                return e.$router.push("/message_list")
                            }
                        }
                    }), e._v(" "), i("van-grid-item", {
                        attrs: {
                            icon: "./static/images/new.png?t=1",
                            text: e.$t("new[0]")
                        },
                        on: {
                            click: function(t) {
                                e.openVideo(e.$t("new[0]"))
                            }
                        }
                    }), e._v(" "), i("van-grid-item", {
                        attrs: {
                            icon: e.InitData.setting.up_url + e.InitData.setting.yuebao.icon + "?t=2",
                            text: e.InitData.setting.yuebao.name
                        },
                        on: {
                            click: function(t) {
                                return e.$router.push("/user/newLc")
                            }
                        }
                    }), e._v(" "), i("van-grid-item", {
                        attrs: {
                            icon: "./static/images/88.png",
                            text: e.$t("home.menu[3]")
                        },
                        on: {
                            click: function(t) {
                                e.openProfile(e.$t("home.menu[3]"))
                            }
                        }
                    })], 1), e._v(" "), i("div", {
                        staticClass: "abs"
                        ...
                        staticClass: "Title1",
                        attrs: {
                            title: e.$t("home.memberList.title"),
                            border: !1
                        }
                    }), e._v(" "), i("div", {
                        staticStyle: {
                    ...
                    }, e._l(e.InitData.memberList, function(t, s) {
                        return i("van-swipe-item", {
                            key: s,
                            attrs: {
                                index: s
                            ...
                            staticClass: "topItem",
                            attrs: {
                                icon: "./static/head/" + t.header + "?t=2",
                                title: e.$t("home.memberList.data[0]", {
                                    member: t.username
                                }),
                                label: e.$t("home.memberList.data[2]"),
                                center: ""
                            }
                        }, [i("template", {
                            slot: "right-icon"
                            ...
                            staticClass: "profit"
                        }, [e._v("\n                " + e._s(t.profit || "0.00") + e._s(e.InitData.currency) + "\n              ")])])], 2)], 1)
                    }), 1)], 1)], 1)], 1), e._v(" "), i("Footer"), e._v(" "), i("van-popup", {
                        staticStyle: {
                    ...
                    }, [e.InitData.noticelist && e.InitData.noticelist.length ? i("dl", {
                        staticClass: "NoticePopup",
                        staticStyle: {
                            background: "linear-gradient(226deg, rgb(45 220 212), rgb(118 156 156)) 0% 0% / 100% 100%",
                            "background-size": "100% 100%"
                        },
                        on: {
                            click: function(t) {
                                return e.$router.push("/article/notice/" + e.InitData.noticelist[0].id)
                            }
                        }
                    }, [i("dt", [e._v(e._s(e.$t("home.noticeTitle")))]), e._v(" "), i("dd", {
                        domProps: {
                            innerHTML: e._s(e.InitData.noticelist[0].content)
                        }
                    })]) : e._e(), e._v(" "), i("a", {
                        staticClass: "close",
                        attrs: {
                        ...
                        domProps: {
                            innerHTML: e._s(e.InitData.setting.info_w)
                        }
                    })]), e._v(" "), i("a", {
                        staticClass: "close",
                        attrs: {
        ...
        var n = function(e) {
            ...
            r = i("VU/8")(s.a, a, !1, n, "data-v-c336106a", null);
        t.default = r.exports
    },
    v2ns: function(e, t) {}
});